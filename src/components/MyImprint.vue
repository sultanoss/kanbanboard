<template>
  <div class="impressum">
    ...
    <p>
      ...
      Telefon: 0049-015752967559<br />
      E-Mail:
      <a class="my-email" href="mailto:radwansultan@hotmail.de"
        >radwansultan@hotmail.de</a
      >
    </p>
    <p>
      ...
      werden wir derartige Links umgehend entfernen.<br /><br /><strong
        >Urheberrecht</strong
      ><br /><br />
      ...
      beschriebenen Art und Weise und zu dem zuvor benannten Zweck einverstanden.<br /><br /><strong
      ...
      ermöglicht. Google Adsense verwendet auch sog. ''Web Beacons'' (kleine unsichtbare
      Grafiken) zur Sammlung von Informationen. Durch die Verwendung des Web Beacons
      können einfache Aktionen wie der Besucherverkehr auf der Webseite aufgezeichnet und
      gesammelt werden. Die durch den Cookie und/oder Web Beacon erzeugten Informationen
      über Ihre Benutzung dieser Website (einschließlich Ihrer IP-Adresse) werden an einen
      Server von Google in den USA übertragen und dort gespeichert. Google wird diese
      Informationen benutzen, um Ihre Nutzung der Website im Hinblick auf die Anzeigen
      ...
      Verbindung bringen. Das Speichern von Cookies auf Ihrer Festplatte und die Anzeige
      von Web Beacons können Sie verhindern, indem Sie in Ihren Browser-Einstellungen
      ...
      Einstellungen > Datenschutz > Cookies''); wir weisen Sie jedoch darauf hin, dass Sie
    ...
    <a class="my-email" href="https://www.impressum-generator.de"
      >impressum-generator.de</a
    >
    von der
    <a class="my-email" href="https://www.kanzlei-hasselbach.de/" rel="nofollow"
